...
val gh = GitHubSettings(org = "ArulselvanMadhavan", proj = "shapeless-playground", publishOrg = "com.arulselvan", license = apache2)
val devs = Seq(Dev("Arulselvan Madhavan", "@ArulselvanMadhavan"))
