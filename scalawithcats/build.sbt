...
val gh = GitHubSettings(org = "scalaProjects", proj = "ScalaWithCats", publishOrg = "com.arulselvan", license = apache2)
val devs = Seq(Dev("ArulselvanMadhavan", "@Arulselvanmadhavan"))
