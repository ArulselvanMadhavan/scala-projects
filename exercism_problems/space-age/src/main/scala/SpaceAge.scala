...
object SpaceAge {
  ...
  def onEarth(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(1.0)

  def onMercury(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(0.2408467)

  def onVenus(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(0.61519726)

  def onMars(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(1.8808158)

  def onJupiter(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(11.862615)

  def onSaturn(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(29.447498)

  def onUranus(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(84.016846)

  def onNeptune(secs: Double): Double =
    (format _ compose (earthYearInSecs _)(secs))(164.79132)
}
